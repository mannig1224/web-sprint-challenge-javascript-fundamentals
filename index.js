...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
/* nestedFunction is a child of myFunction therefore it has access to the variables declared by its parent.
...
const zooAnimals = [
  ...
  */
  ...
  function lowerCaseNames(data){
    const lowerCase = data.map(item => item.animal_name.toLowerCase());
    return lowerCase;
  }
  ...
  */
  ...
  function lowPopulationAnimals(data){
    ...
    const lowPopulationList = data.filter(function(item){
     return item.population < 5;
    })
    return lowPopulationList;
